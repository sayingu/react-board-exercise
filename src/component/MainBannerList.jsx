...
const MainBannerList = () => {
    ...
    const getList = () => {
        fetch(`${process.env.REACT_APP_API_URL}/mainBanner?page=${page}&countPerPage=${countPerPage}&srchSubject=${srchSubject}&srchWriter=${srchWriter}&srchDateFrom=${srchDateFrom}&srchDateTo=${srchDateTo}`).then(res => {
            res.json().then(json => {
